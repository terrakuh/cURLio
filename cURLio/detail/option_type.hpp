...
struct Option_type<
  ...
  std::enable_if_t<contains<
    Option, CURLOPT_URL, CURLOPT_PROXY, CURLOPT_USERPWD, CURLOPT_PROXYUSERPWD, CURLOPT_RANGE,
    CURLOPT_POSTFIELDS, CURLOPT_REFERER, CURLOPT_FTPPORT, CURLOPT_USERAGENT, CURLOPT_COOKIE, CURLOPT_SSLCERT,
    CURLOPT_KEYPASSWD, CURLOPT_COOKIEFILE, CURLOPT_CUSTOMREQUEST, CURLOPT_INTERFACE, CURLOPT_KRBLEVEL,
    CURLOPT_CAINFO,
#if !CURL_AT_LEAST_VERSION(7, 84, 0)
    CURLOPT_RANDOM_FILE, CURLOPT_EGDSOCKET,
#endif
    CURLOPT_COOKIEJAR, CURLOPT_SSL_CIPHER_LIST, CURLOPT_SSLCERTTYPE, CURLOPT_SSLKEY, CURLOPT_SSLKEYTYPE,
    CURLOPT_SSLENGINE, CURLOPT_CAPATH, CURLOPT_ACCEPT_ENCODING, CURLOPT_NETRC_FILE, CURLOPT_FTP_ACCOUNT,
    CURLOPT_COOKIELIST, CURLOPT_FTP_ALTERNATIVE_TO_USER, CURLOPT_SSH_PUBLIC_KEYFILE,
    CURLOPT_SSH_PRIVATE_KEYFILE, CURLOPT_SSH_HOST_PUBLIC_KEY_MD5, CURLOPT_COPYPOSTFIELDS, CURLOPT_CRLFILE,
...
#endif
    CURLOPT_SSH_KNOWNHOSTS, CURLOPT_MAIL_FROM, CURLOPT_RTSP_SESSION_ID, CURLOPT_RTSP_STREAM_URI,
    CURLOPT_RTSP_TRANSPORT, CURLOPT_TLSAUTH_USERNAME, CURLOPT_TLSAUTH_PASSWORD, CURLOPT_TLSAUTH_TYPE,
    CURLOPT_DNS_SERVERS, CURLOPT_MAIL_AUTH, CURLOPT_XOAUTH2_BEARER, CURLOPT_DNS_INTERFACE,
    CURLOPT_DNS_LOCAL_IP4, CURLOPT_DNS_LOCAL_IP6, CURLOPT_LOGIN_OPTIONS, CURLOPT_PINNEDPUBLICKEY,
    CURLOPT_UNIX_SOCKET_PATH, CURLOPT_PROXY_SERVICE_NAME, CURLOPT_SERVICE_NAME, CURLOPT_DEFAULT_PROTOCOL,
    CURLOPT_PROXY_CAINFO, CURLOPT_PROXY_CAPATH, CURLOPT_PROXY_TLSAUTH_USERNAME,
    CURLOPT_PROXY_TLSAUTH_PASSWORD, CURLOPT_PROXY_TLSAUTH_TYPE, CURLOPT_PROXY_SSLCERT,
    CURLOPT_PROXY_SSLCERTTYPE, CURLOPT_PROXY_SSLKEY, CURLOPT_PROXY_SSLKEYTYPE, CURLOPT_PROXY_KEYPASSWD,
    CURLOPT_PROXY_SSL_CIPHER_LIST, CURLOPT_PROXY_CRLFILE, CURLOPT_PRE_PROXY, CURLOPT_PROXY_PINNEDPUBLICKEY,
    CURLOPT_ABSTRACT_UNIX_SOCKET, CURLOPT_REQUEST_TARGET, CURLOPT_TLS13_CIPHERS, CURLOPT_PROXY_TLS13_CIPHERS,
    CURLOPT_DOH_URL, CURLOPT_ALTSVC, CURLOPT_SASL_AUTHZID, CURLOPT_PROXY_ISSUERCERT, CURLOPT_SSL_EC_CURVES,
    CURLOPT_HSTS, CURLOPT_AWS_SIGV4, CURLOPT_SSH_HOST_PUBLIC_KEY_SHA256>>> {
	using type = const char*;
};
...
template<CURLoption Option>
struct Option_type<
  Option, std::enable_if_t<
            contains<Option, CURLOPT_WRITEDATA, CURLOPT_READDATA, CURLOPT_HEADERDATA, CURLOPT_XFERINFODATA,
                     CURLOPT_DEBUGDATA, CURLOPT_SSL_CTX_DATA,
#if !CURL_AT_LEAST_VERSION(7, 18, 0)
                     CURLOPT_IOCTLDATA,
#endif
                     CURLOPT_SOCKOPTDATA, CURLOPT_OPENSOCKETDATA, CURLOPT_SEEKDATA, CURLOPT_SSH_KEYDATA,
                     CURLOPT_INTERLEAVEDATA, CURLOPT_CHUNK_DATA, CURLOPT_FNMATCH_DATA,
                     CURLOPT_CLOSESOCKETDATA, CURLOPT_RESOLVER_START_DATA, CURLOPT_TRAILERDATA,
                     CURLOPT_HSTSREADDATA, CURLOPT_HSTSWRITEDATA, CURLOPT_PREREQDATA>>> {
	using type = void*;
};
