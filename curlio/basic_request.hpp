...
public:
	...
	Basic_request(const Basic_request& copy) = delete;
...
private:
	...
	CURL* _handle;
	detail::Function<std::size_t(boost::system::error_code, char*, std::size_t)> _send_handler;
...
using Request = Basic_request<boost::asio::any_io_executor>;
